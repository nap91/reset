...
export default function PlanPreviewScreen() {
  ...
  const runAnalysis = useCallback(async () => {
    ...
    try { const result = await analyzeRoomPhoto(photoUri, minutes, goal); setPlan(result.plan); }
