...
export default function ResetCompleteScreen() {
  const { sessionId, completed = '0', total = '0', minutes = '0' } = useLocalSearchParams<{ sessionId?: string; completed?: string; total?: string; minutes?: string }>();
