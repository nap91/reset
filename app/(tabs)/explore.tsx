    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.streakCard}>
          ...
          <Text style={styles.streakNumber}>0</Text><Text style={styles.streakLabel}>day reset streak</Text><Text style={styles.streakHint}>Complete your first reset to begin.</Text>
        </View>
        <Text style={styles.sectionLabel}>THIS WEEK</Text>
        <View style={styles.statsRow}>
          <View style={styles.statCard}><Ionicons name="checkmark-circle-outline" size={24} color={C.green} /><Text style={styles.statNumber}>0</Text><Text style={styles.statLabel}>Resets</Text></View>
          <View style={styles.statCard}><Ionicons name="time-outline" size={24} color={C.green} /><Text style={styles.statNumber}>0</Text><Text style={styles.statLabel}>Minutes</Text></View>
        </View>
        <View style={styles.emptyCard}>
          <View style={styles.emptyIcon}><Ionicons name="images-outline" size={26} color={C.green} /></View>
          <Text style={styles.emptyTitle}>Your resets will live here</Text><Text style={styles.emptyText}>Before-and-after photos and completed sessions will appear after your first reset.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
